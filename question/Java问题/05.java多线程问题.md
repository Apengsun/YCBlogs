...
- 线程池好处：
    - 1）降低资源消耗；
    - 2）提高相应速度；
    - 3）提高线程的可管理性。[技术博客大总结](https://github.com/Apengsun/YCBlogs)
- 线程池的实现原理：
...
- 2、yield()方法[技术博客大总结](https://github.com/Apengsun/YCBlogs)
...
- 线程安全也是有几个级别
    ...
    - 线程非安全[技术博客大总结](https://github.com/Apengsun/YCBlogs)
...
#### 5.0.1.9 synchonized(this)和synchonized(object)区别？Synchronize作用于方法和静态方法区别？
- synchonized(this)和synchonized(object)区别[技术博客大总结](https://github.com/Apengsun/YCBlogs)
...
- Synchronize作用于方法和静态方法区别
    ...
    - 在普通方法前加synchronized：非static方法获取到的锁，是属于当前对象的锁。 [技术博客大总结](https://github.com/Apengsun/YCBlogs)
