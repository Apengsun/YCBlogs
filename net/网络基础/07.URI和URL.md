...
- https://github.com/Apengsun/LifeHelper      这个是url
...
- URI一般由三部组成
    - ①访问资源的命名机制
    - ②存放资源的主机名
    - ③资源自身的名称，由路径表示，着重强调于资源。[博客](https://github.com/Apengsun/YCBlogs)
...
### 04.URI常用模式
- URI当前的常用模式包括：
    - data：链接中直接包含经过BASE64编码的数据。[博客](https://github.com/Apengsun/YCBlogs)
    - file：本地磁盘上的文件。
    - ftp：FTP服务器。
    - http：使用超文本传输协议。
    - mailto：电子邮件的地址。
...
### 08.拼接url链接字符串工具类
- 比如：https://github.com/Apengsun/LifeHelper?name=yc&age=26
- 如下所示
    ```
    /**
     * 拼接字符串
