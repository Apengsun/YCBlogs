...
- Toast封装库项目地址：https://github.com/Apengsun/YCDialog
...
- 在构造方法中，创建了NT对象，那么有人便会问，NT是什么东西呢？于是带着好奇心便去看看NT的源码，可以发现NT实现了ITransientNotification.Stub，提到这个感觉是不是很熟悉，没错，在aidl中就会用到这个。
    - 针对aidl，如果有人不明白，可以参考我的这边文章[Aidl进程间通信详细介绍](https://github.com/Apengsun/YCBlogs/blob/master/android/%E7%BB%8F%E5%85%B8%E6%80%BB%E7%BB%93/02.Aidl%E8%BF%9B%E7%A8%8B%E9%97%B4%E9%80%9A%E4%BF%A1%E8%AF%A6%E7%BB%86%E4%BB%8B%E7%BB%8D.md)主要是Aidl相关属性介绍，实际开发中案例操作，部分源码解析，客户端绑定服务端service原理
    ```
    public Toast(Context context) {
        mContext = context;
        mTN = new TN();
...
#### 2.5 TN类中的消息机制
- 看源码可知，TN中的消息机制也是通过handler消息机制实现的。如果对handler 消息机制还不太熟悉，可以查看我的这篇博客：[Handler消息机制](https://github.com/Apengsun/YCBlogs/blob/master/android/%E6%B6%88%E6%81%AF%E6%9C%BA%E5%88%B6/01.Handler%E6%B6%88%E6%81%AF%E6%9C%BA%E5%88%B6.md)
...
- 具体可以参考我的弹窗封装库：https://github.com/Apengsun/YCDialog
...
### 4.Toast封装库介绍
#### 4.1 能够满足的需求
- 可以设置吐司的位置，偏移，吐司文字颜色，吐司背景颜色等等。简单的代码就可以实现你需要的多种场景。也可以设置定义布局的吐司。项目地址：https://github.com/Apengsun/YCDialog
