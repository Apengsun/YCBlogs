...
- Snackbar封装库项目地址：https://github.com/Apengsun/YCDialog
...
- 创建Snackbar需要使用静态的make方法，并且其中的view参数是一个查找父布局的起点
    - 这里可以看到，snackBar的布局是design_layout_snackbar_include，假如我们需要自定义SnackBar并且设置字体颜色，大小等属性。则需要拿到这个布局的控件id等。关于封装库，可以查看：https://github.com/Apengsun/YCDialog
