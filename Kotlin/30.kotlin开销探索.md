...
### 04.伴生对象开销
- 伴生对象通过在类中使用companion object来创建，用来替代静态成员，类似于Java中的静态内部类。所以在伴生对象中声明常量是很常见的做法，但如果写法不对，可能就会产生额外开销。[博客](https://github.com/Apengsun/YCBlogs)
- 看下面代码
    ```
    class Android {
        fun getVersion(): Int {
...
### 05.基本类型数组
- 在Kotlin中有3种数组类型：[博客](https://github.com/Apengsun/YCBlogs)
